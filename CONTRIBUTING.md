# Contributing to video-summarizer-extension

Thank you for your interest in contributing to video-summarizer-extension! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/video-summarizer-extension.git
   cd video-summarizer-extension
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/video-summarizer-extension.git
   ```
...
By contributing to video-summarizer-extension, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
